...
export function LearnMoreButton({ children }: { children: React.ReactNode }) {
  ...
  return (
    <>
      <Button onClick={() => setOpen(true)} className="bg-cyan-500 hover:bg-cyan-600 text-white">
        {children}
      </Button>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="sm:max-w-[425px] bg-slate-800 text-white border-slate-700">
          <DialogHeader>
            <DialogTitle className="text-xl text-white">Learn More About SecureFront</DialogTitle>
            <DialogDescription className="text-gray-300">
              Fill out this form and we'll get back to you with more information about our services.
            </DialogDescription>
          </DialogHeader>
